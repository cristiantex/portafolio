...
<div class="bg-white rounded-lg shadow p-6 w-full min-h-[80vh]">
    ...
    <h2 class="text-2xl font-bold mb-4 text-gray-800">Editar Experiencia</h2>
    ...
    <form action="{{ route('experiencias.update', $experiencia) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="empresa" value="{{ old('empresa', $experiencia->empresa) }}"
        ...
        <div>
            ...
            <input type="text" name="cargo" value="{{ old('cargo', $experiencia->cargo) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            {{-- Fecha de inicio --}}
            <div>
                <label class="block text-gray-700 font-medium mb-1"> Fecha de Inicio <span class="text-red-500">*</span> </label>
        ...
        <div>
            ...
            <input type="text" name="tecnologias" 
                value="{{ old('tecnologias', is_array($experiencia->tecnologias) ? implode(', ', $experiencia->tecnologias) : $experiencia->tecnologias) }}"
        ...
        <div>
            ...
            <textarea name="descripcion" rows="3"
                      class="w-full px-4 py-2 rounded border @error('descripcion') border-red-500 @else border-gray-300 @enderror
                             focus:ring-2 focus:ring-blue-400 focus:outline-none">{{ old('descripcion', $experiencia->descripcion) }}</textarea>
            @error('descripcion')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
