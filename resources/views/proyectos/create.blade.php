...
<div class="bg-white rounded-lg shadow p-6 w-full min-h-[80vh]">
    ...
    <h2 class="text-2xl font-bold mb-4 text-gray-800">Agregar Proyecto</h2>
    ...
    <form action="{{ route('proyectos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="flex items-center space-x-2">
            <input type="checkbox" name="publicado" value="1" {{ old('publicado') ? 'checked' : '' }} id="publicado">
