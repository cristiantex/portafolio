...
@section('title', 'Agregar Tecnología')

@section('content')
<div class="bg-white rounded-lg shadow p-6 w-full min-h-[80vh]">

    <h2 class="text-2xl font-bold mb-4 text-gray-800">Agregar Tecnología</h2>
    ...
    <form action="{{ route('tecnologias.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="number" name="experiencia_anios" min="0" value="{{ old('experiencia_anios') }}"
